...
def purged_kfold(events_end_idx: np.ndarray, n_folds: int = 5, embargo: int = 50):
    ...
    for fs in fold_sizes:
        ...
        test_start = events_end_idx[test_idx].min()
        train_mask = (events_end_idx < test_start) | (events_end_idx > test_end)
