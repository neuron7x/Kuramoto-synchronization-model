...
from tradepulse.core.neuro.neuro_optimizer import BalanceMetrics, NeuroOptimizer, OptimizationConfig
...
class TestNeuroOptimizer:
    ...
    def test_optimize_tracks_best_objective(
    ...
    def test_get_optimization_report_with_data(
        self, opt_config, sample_params, sample_state
    ):
