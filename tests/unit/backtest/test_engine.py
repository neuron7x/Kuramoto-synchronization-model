...
class TestLatencyConfig:
    ...
    def test_latency_config_custom_values(self) -> None:
        ...
        config = LatencyConfig(
            signal_to_order=1, order_to_execution=2, execution_to_fill=1
        )
    ...
    def test_total_delay_never_negative(self) -> None:
        ...
        config = LatencyConfig(
            signal_to_order=0, order_to_execution=0, execution_to_fill=0
        )
...
class TestWalkForward:
    ...
    def test_walk_forward_enforces_position_limits(self) -> None:
        ...
        result = walk_forward(
            prices, aggressive_signal, fee=0.0, constraints=constraints
        )
