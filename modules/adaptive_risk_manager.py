...
class PositionLimit(BaseModel):
    ...
    take_profit_pct: Optional[float] = Field(default=None, gt=0, description="Відсоток тейк-профіту")
...
class AdaptiveRiskManager:
    ...
    def update_position_limits(
        ...
        Args:
            ...
            volatility: Поточна волатільність
    ...
    def should_reduce_risk(self, portfolio_risk: PortfolioRisk) -> bool:
        ...
        """
        return (
            portfolio_risk.risk_level in [RiskLevel.HIGH, RiskLevel.CRITICAL] or
            portfolio_risk.market_condition == MarketCondition.EXTREME or
            portfolio_risk.utilization_pct > 85
        )
    ...
    def get_risk_summary(self) -> Dict:
        ...
        metrics = self.calculate_risk_metrics(returns_array)
