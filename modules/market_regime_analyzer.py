...
class MarketRegimeAnalyzer:
    ...
    def classify_regime(
        ...
        if confidence < self.transition_threshold and self._regime_duration >= self.min_regime_duration:
    ...
    def get_regime_summary(self) -> Dict:
        ...
        return {
            ...
            "duration_bars": self._regime_duration,
            "regime_start_time": self._regime_start_time.isoformat() if self._regime_start_time else None,
