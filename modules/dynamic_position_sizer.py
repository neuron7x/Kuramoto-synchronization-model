        ...
        **kwargs
        ...
        if method == SizingMethod.ADAPTIVE:
            return self.calculate_adaptive_size(
                symbol, price, volatility, confidence,
                kwargs.get('win_rate'),
                kwargs.get('avg_win'),
                kwargs.get('avg_loss')
            )
        ...
        if method == SizingMethod.FIXED:
            ...
            recommended_size = self.calculate_volatility_adjusted_size(
                volatility, base_size
            ) * confidence
            ...
            recommended_size = self.calculate_risk_parity_size(
                symbol, volatility, portfolio_vols
            ) * confidence
