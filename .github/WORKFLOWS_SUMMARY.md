...
|----------|------|---------|------|
| **Tests** | `tests.yml` | Comprehensive test suite for all PRs (lint, type-check, unit, integration, property tests) | Every PR |
...
| **Performance Regression** | `performance-regression.yml` | Detect performance regressions | PRs (excluding docs) |
...
4. **Performance**: No regressions >10% allowed
