...
def validate_agent_prompt(prompt_file: Path) -> tuple[bool, list[str]]:
    ...
    protocol_steps = ["INTENT", "MISMATCH", "REFACTOR PLAN", "SAFE PATCH", "VERIFY LOOP"]
    ...
    protocol_subsections = ["**5.1. INTENT", "**5.2. MISMATCH", "**5.3. REFACTOR PLAN", 
                           "**5.4. SAFE PATCH", "**5.5. VERIFY LOOP"]
