...
- **Exploit Protection**: `.github/workflows/tests.yml` and `security.yml` block merges unless SAST (bandit/mypy/ruff/golangci-lint), dependency-check (`pip-audit` + constraints), linter, and CycloneDX SBOM jobs succeed.  
