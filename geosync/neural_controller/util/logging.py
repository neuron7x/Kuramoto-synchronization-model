...
_DEFAULT_LOGGER_NAME = "geosync.neural_controller"
...
def setup_logger(level: str = "INFO") -> None:
    ...
    ``level`` argument and the ``GEOSYNC_NEURO_LOG_LEVEL`` environment
    variable (the environment variable wins when provided).
    """

    env_level = os.environ.get("GEOSYNC_NEURO_LOG_LEVEL")
