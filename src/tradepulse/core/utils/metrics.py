...
try:  # pragma: no cover - exercised indirectly in environments without numpy
    ...
    from tradepulse.core.accelerators.numeric import quantiles as _numpy_quantiles
...
if TYPE_CHECKING:  # pragma: no cover - import cycle guard for type hints
    from tradepulse.analytics.environment_parity import MetricDeviation
...
def start_metrics_exporter_process(
    ...
    from tradepulse.observability.exporters import start_prometheus_exporter_process
...
def stop_metrics_exporter_process(
    ...
    from tradepulse.observability.exporters import stop_exporter_process
