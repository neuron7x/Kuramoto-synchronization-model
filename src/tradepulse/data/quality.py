...
class DataQualityReport:
    ...
    def add_issue(self, issue: DataQualityIssue) -> None:
        ...
        elif issue.severity == IssueSeverity.ERROR and self.status != DataQualityStatus.CRITICAL:
            self.status = DataQualityStatus.CRITICAL
        elif issue.severity == IssueSeverity.WARNING and self.status == DataQualityStatus.OK:
