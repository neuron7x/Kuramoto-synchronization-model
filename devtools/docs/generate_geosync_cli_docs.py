...
from geosync.cli.geosync_cli import cli  # noqa: E402
...
def _collect_help(args: Iterable[str]) -> str:
    ...
    if result.exit_code != 0:
        raise RuntimeError(f"Failed to render help for '{' '.join(args)}': {result.output}")
...
def build_documentation() -> str:
    header = dedent("""
        ...
        _This file is auto-generated by `devtools/docs/generate_geosync_cli_docs.py`. Do not edit manually._
        """).strip()
