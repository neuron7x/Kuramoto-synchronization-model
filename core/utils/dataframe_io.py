...
def _select_backend(require_parquet: bool, allow_json_fallback: bool) -> _Backend:
    ...
    raise MissingParquetDependencyError(
        "No parquet backend available. Install 'tradepulse[feature_store]' for pyarrow support or install polars."  # noqa: E501
    )
        ...
        if suffix == _PARQUET_SUFFIX:
            ...
            if _pyarrow_available():
                ...
                try:
                    ...
                    raise MissingParquetDependencyError(
                        "Unable to read parquet file without pyarrow or polars. Install 'tradepulse[feature_store]'."  # noqa: E501
                    ) from exc
