...
class BehavioralProfile:
    ...
    def generate_report(self) -> str:
        ...
        lines = [
            ...
            f"  Phasic Burst Frequency:       {self.tonic_phasic.phasic_burst_frequency:.4f} bursts/step",  # noqa: E501
            ...
            f"  Desensitization Onset:        {self.tonic_phasic.desensitization_onset_time:.0f} steps",  # noqa: E501
            "",
            "VETO/COOLDOWN CHARACTERISTICS",
            "-" * 80,
            f"  Veto Threshold:               {self.veto_cooldown.veto_threshold:.4f}",
            f"  Veto Activation Latency:      {self.veto_cooldown.veto_activation_latency:.2f} steps",  # noqa: E501
            f"  Veto Deactivation Latency:    {self.veto_cooldown.veto_deactivation_latency:.2f} steps",  # noqa: E501
            "",
            ...
            f"  Cooldown Frequency:           {self.veto_cooldown.cooldown_frequency:.2f} per 100 steps",  # noqa: E501
            "",
            ...
            "",
            f"  Stress Mean ± Std:            {self.statistics.stress_mean:.3f} ± {self.statistics.stress_std:.3f}",  # noqa: E501
            f"  Stress Max:                   {self.statistics.stress_max:.3f}",
            "",
            f"  Serotonin Mean ± Std:         {self.statistics.serotonin_mean:.3f} ± {self.statistics.serotonin_std:.3f}",  # noqa: E501
