...
def main():
    parser = argparse.ArgumentParser(description="Compare two thermodynamic state snapshots")
    ...
    parser.add_argument("--output", "-o", type=Path, help="Output path for JSON comparison report")
