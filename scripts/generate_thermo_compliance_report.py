...
def load_audit_entries(log_path: Path, start_date: datetime, end_date: datetime) -> List[Dict[str, Any]]:
...
def analyze_compliance(entries: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    return {
        ...
        "circuit_breaker_activations": sum(1 for e in entries if e.get('circuit_breaker_active', False)),
