...
def main():
    ...
    parser.add_argument(
        "--duration", type=str, default="1h", help="Token validity duration (e.g., 1h, 24h, 7d)"
    )
    ...
    parser.add_argument(
        "--type", choices=["override", "dual_approval"], default="override", help="Token type"
    )
    ...
    if duration_str.endswith("h"):
        ...
        print(
            f"Error: Invalid duration format '{args.duration}'. Use format like '1h', '24h', or '7d'"  # noqa: E501
        )
        return 1
